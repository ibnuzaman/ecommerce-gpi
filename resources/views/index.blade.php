...
<body>
  <nav class="navbar navbar-expand-lg fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand ps-3" href="{{ route('index')}}"><img src=" ./assets/img/logo GPI.png" alt="" width="100px"></a>
      ...
      <div class="carousel-inner">
        <div class="carousel-item car-item-landing active" id="gpi">
          <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 py-2">
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec eget condimentum risus. Etiam vitae augue neque. Donec ultrices elit augue, eget consectetur felis molestie non. In metus ligula, auctor sit amet rutrum id, eleifend at odio. Donec blandit purus quis augue efficitur congue. Cras tincidunt porta tincidunt. Quisque ultricies ac mauris non hendrerit. Proin congue felis a nisl vulputate, non suscipit ipsum dapibus.</p>
            </div>
          </div>
        </div>
      ...
      <div class="row row-content">
        <div class="col-md-4">
          ...
          <div class="row pb-3 footer-link">
            ...
            <a href="#garish" class="row-content pt-4">
              <i>
            ...
            <a href="#tridaya" class="row-content pt-4 pb-2">
              <i>
