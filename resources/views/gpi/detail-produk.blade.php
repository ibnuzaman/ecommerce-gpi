    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="nav-welcome-button ps-lg-3 ps-4 pt-auto">
                    <button class="welcome-btn pe-4" id="welcomeBtn">
                      Welcome, <span id="nav-username">Azzahra</span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="white" class="bi bi-person-fill" viewBox="0 0 16 20">
          ...
          <div class="col-xl-6">
            <div class="product-info">
              ...
              <div class=" mt-auto actions">
                ...
                <button class="btn btn-dtl-beli" onclick="openForm()">Buy Now</button>
                <div class="form-popup" id="myForm">
                  <form action="/action_page.php" class="form-container">
                    ...
                    <b>Pesanan Anda</b>
                    <hr>
                    <label for="nama-produk"><p>Produk A</p></label>
                    <br>
                    <label for="harga"><p>Dengan Harga: <span>Rp.100.000</span></p></label>
                    <br>
                    <label for="qty"><p>Dengan Jumlah Barang: <span>10</span></p></label>
                    <button type="submit" class="btn">Bayar tod </button>
